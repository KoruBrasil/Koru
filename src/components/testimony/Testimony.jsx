    ...
    return (
        <div>
            <div className='pt-20 flex  flex-col justify-center items-center'>
                ...
                <div className='bg-blue-700 text-white lg:w-[460px] h-[458px] lg:mr-[600px] p-10 space-y-9 rounded-lg lg:absolute'>
            ...
            <div className='pt-20  flex flex-col justify-center items-center'>
                ...
                <div className='bg-blue-700 text-white lg:w-[460px] h-[458px] lg:ml-[700px] p-10 space-y-9 rounded-lg lg:absolute'>
                    <p>Lorem, ipsum dolor sit amet...</p>
                    <h2 className='text-2xl '>Lorem, ipsum doler sit amet lorem...</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum sint voluptatum, est consequuntur eveniet tempore consectetur non esse quo molestias facere cum voluptatibus fuga accusantium accusamus doloribus provident.</p>
                    <button className='border border-zinc-400 rounded px-5 py-2'>Ler mais</button>
            ...
            <div className='bg-blue-700 mt-5'>
                ...
                <Carousel showArrows={true} showStatus={false} interval={5000} infiniteLoop transitionTime={1100} className='text-white lg:text-2xl lg:mx-20 mt-20'>
